...
export default function ProfilDesa() {
  ...
  // Auto-slide songket images setiap 4 detik (sama seperti di beranda)
  useEffect(() => {
            ...
            <div className="text-center text-white px-4">
              ...
              <p className="text-lg font-poppins opacity-90 max-w-3xl mx-auto">
                {String(lang) === 'id'
                  ...
                  : 'Get to know Silungkang Oso Tourism Village more closely: its nature, culture, and community.'}
              </p>
            </div>
          </div>
        </div>

        {/* Section: Tentang Desa Silungkang Oso */}
        <section className="px-4 sm:px-6 lg:px-8 mt-16 md:mt-24 mb-16">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8">
              ...
              <div className="w-24 h-1 bg-[#ffd704] mx-auto rounded-full mt-3"></div>
            </div>
            
            <div className="mb-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                {/* Kolom Kiri - Judul & Deskripsi (satu kolom) */}
        ...
        <div className="py-16 bg-[#fffcf9]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                {/* Songket Image Slider (sama seperti di beranda) */}
                ...
                {/* Songket Info (sama seperti di beranda: border-left) */}
