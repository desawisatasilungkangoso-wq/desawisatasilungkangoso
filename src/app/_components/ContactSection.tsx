...
export default function ContactSection({ showForm = true, className = "" }: ContactSectionProps) {
    ...
    <section className={`px-4 sm:px-6 lg:px-8 mb-16 ${className}`}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {/* Form Kontak - Only show if showForm is true */}
          {showForm && (
            <div className="space-y-6 flex flex-col justify-start">
              <h3 className="text-2xl font-bold text-gray-800 font-poppins mb-6">
              ...
              <div className="bg-white rounded-xl p-8 shadow-md border border-gray-100">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {/* Formspree configuration handled in JavaScript */}
